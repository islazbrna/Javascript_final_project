...
const filmyNovyObsah = filmy.map((jedenFilm) => {
  return `<div class="col">
   <div class="card">
      ...
      />
      <div class="card-body">
         <h5 class="card-title">${jedenFilm.nazev}</h5>
         <p class="card-text">${jedenFilm.ochutnavka}</p>
          <a href="film.html#${jedenFilm.id}" class="btn btn-primary">Přehrát</a>
      </div>
   </div>
</div> ` 
});
